...
.navbar-nav li a:hover, .navbar-nav li.active a {
	...
	/*border-bottom: 3px solid #456789;*/
}
...
<div class="row">
		...
		<div class="col-sm-4 text-center">
			<p>This study program allows me to learn  technicales knowledge, such as computer programming, microcontroller programming and so on.
			They are provided by the Institut Universitaire Technologie of Saint-Etienne and also by the department of Science of Université Jean-Monnet.</p>
 		</div>
  ...
  <div class="container-fluid bg-grey">
	<div class="row">
		...
		<div class="col-sm-8">
		<h2>My Values</h2>
		<h4>What do <Strong>DEFINE</strong> me? As a motivated person, curious, i like meet challenges and work on high-impact project.</h4>
		<h4>My<strong> MOTTO:</strong> Innovate, Optimize and Progress.</h4>
		</div>
	</div>
</div>
